...
tejma3 les poids ta3 un terme ou ta9semhom 3la nombre de documents (vertical)
...
> - $M$ = Nombre de termes
> - $Maxd_{ij}$ = poids du terme lekbir kamel f document (chouf horizentalement)

> [!abstract] Similitude
> $$\operatorname{Sim}(d_i, V) = 1 - \sqrt{\frac{\sum_{j=1}^{M} |d_{ij} - V_j|^2}{\text{MaxS}}}$$
> - $d_{ij}$ = poids du terme 
> - $V$ = vecteur centroide
